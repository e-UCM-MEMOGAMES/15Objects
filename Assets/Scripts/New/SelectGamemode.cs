...
public class SelectGamemode : BaseGamemode
{
   ...
   /// </summary>
    ...
    void Start()
    {
        ...
        optionsListObj.SetActive(false);
        ...
        for (int i = 0; i < MAX_ROWS; i++)
        {
            ...
            for (int j = 0; j < MAX_COLS; j++)
            {
                ...
                // usar scripts de otros objetos, no puede hacerse desde la interfaz)
